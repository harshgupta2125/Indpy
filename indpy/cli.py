...
def main():
    ...
    if args.command == "check":
        func_map = {
            ...
            "dl": validators.is_dl,
            "uan": validators.is_uan,
            "abha": validators.is_abha,
            "fssai": validators.is_fssai,
            "pran": validators.is_pran,
    ...
    # Logic for GEN
        ...
        gen_map = {
            ...
            "uan": generators.Generate.uan,
            "abha": generators.Generate.abha,
            "fssai": generators.Generate.fssai,
            "pran": generators.Generate.pran,
